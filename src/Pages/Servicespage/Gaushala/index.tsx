...
import { paragraph1, paragraph2, paragraph3, paragraph4, paragraph5, paragraph6, paragraph7, paragraph8 } from './constant';
...
export const Gaushala = () => {
    return (
        <ServiceWrapper>
            <HeadStyle><h1> Goverdhan Gaushala</h1></HeadStyle>
            <TextWrapper>
