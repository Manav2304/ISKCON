export const devoteekitchen = [
    ...
    "Every day, hundreds of people are served delicious and nutritious Krishna Prasad by the devotee kitchen at Sri SriRadha Giridhariji Temple. Starting early in the morning, they prepare a delicious breakfast and then immediately begin preparing the Lunch Prasad. This Prasad is available at a very low cost throughout the year.",
  ];