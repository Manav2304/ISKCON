...
import { options,option1, option2, option3, recurrium, option4, option5, option6 } from "./constant";
...
export const RecurriumDonation = () => {
  ...
  return (
    <>
      <DonationPagesDescription title="Recurrium Donation" content={recurrium} />
      {options.map((option) => (
