...
export const option5: DonationCategory[] = [
  {
    ...
    donations: [
      {
        id: 1,
        title: "Donate Monthly Rs 500 for Youth Preaching Seva",
        amount: 500,
      },
      {
        id: 2,
        title: "Donate Monthly Rs 1000 for Youth Preaching Seva",
        amount: 1000,
      },
      {
        id: 3,
        title: "Donate Monthly Rs 2000 for Youth Preaching Seva",
        amount: 2000,
      },
      {
        id: 4,
        title: "Donate Monthly Rs 3000 for Youth Preaching Seva",
        amount: 3000,
      },
      {
        id: 5,
        title: "Donate Monthly Rs 4000 for Youth Preaching Seva",
        amount: 4000,
      },
      {
        id: 6,
        title: "Donate Monthly Rs 5000 for Youth Preaching Seva",
        amount: 5000,
      },
    ],
  },
...
export const option6: DonationCategory[] = [
  {
    ...
    donations: [
      ...
      {
        id: 3,
        title: "Donate Monthly Rs 1000 for Temple Support",
        amount: 1000,
      },
      {
        id: 4,
        title: "Donate Monthly Rs 2000 for Temple Support",
        amount: 2000,
      },
      {
        id: 5,
        title: "Donate Monthly Rs 3000 for Temple Support",
        amount: 3000,
      },
      {
        id: 6,
        title: "Donate Monthly Rs 5000 for Temple Support",
        amount: 5000,
      },
    ],
  },
